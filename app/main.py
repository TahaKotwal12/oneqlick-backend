...
from app.api.routes import auth, user, restaurant, food_items, search, coupons, partner_restaurant, partner_menu, categories, orders, carts, payments, notifications, pricing, reviews
