...
class Address(Base):
    ...
    full_name = Column(String(100), nullable=False)  # Full name of the person
    phone_number = Column(String(15), nullable=False)  # Phone number
    address_line1 = Column(String(255), nullable=False)  # House number and street
    address_line2 = Column(String(255))  # Area/neighborhood
    ...
    landmark = Column(String(255))  # Nearby landmark
